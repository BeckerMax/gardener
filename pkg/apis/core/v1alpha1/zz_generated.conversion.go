...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*ShootEvent)(nil), (*core.ShootEvent)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_ShootEvent_To_core_ShootEvent(a.(*ShootEvent), b.(*core.ShootEvent), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*core.ShootEvent)(nil), (*ShootEvent)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_ShootEvent_To_v1alpha1_ShootEvent(a.(*core.ShootEvent), b.(*ShootEvent), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*ShootEventList)(nil), (*core.ShootEventList)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_ShootEventList_To_core_ShootEventList(a.(*ShootEventList), b.(*core.ShootEventList), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*core.ShootEventList)(nil), (*ShootEventList)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_ShootEventList_To_v1alpha1_ShootEventList(a.(*core.ShootEventList), b.(*ShootEventList), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_ShootEvent_To_core_ShootEvent(in *ShootEvent, out *core.ShootEvent, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
...
// Convert_v1alpha1_ShootEvent_To_core_ShootEvent is an autogenerated conversion function.
func Convert_v1alpha1_ShootEvent_To_core_ShootEvent(in *ShootEvent, out *core.ShootEvent, s conversion.Scope) error {
	return autoConvert_v1alpha1_ShootEvent_To_core_ShootEvent(in, out, s)
}

func autoConvert_core_ShootEvent_To_v1alpha1_ShootEvent(in *core.ShootEvent, out *ShootEvent, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	out.EventTime = in.EventTime
	out.Action = in.Action
	out.Reason = in.Reason
...
// Convert_core_ShootEvent_To_v1alpha1_ShootEvent is an autogenerated conversion function.
func Convert_core_ShootEvent_To_v1alpha1_ShootEvent(in *core.ShootEvent, out *ShootEvent, s conversion.Scope) error {
	return autoConvert_core_ShootEvent_To_v1alpha1_ShootEvent(in, out, s)
}

func autoConvert_v1alpha1_ShootEventList_To_core_ShootEventList(in *ShootEventList, out *core.ShootEventList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	out.Items = *(*[]core.ShootEvent)(unsafe.Pointer(&in.Items))
	return nil
}

// Convert_v1alpha1_ShootEventList_To_core_ShootEventList is an autogenerated conversion function.
func Convert_v1alpha1_ShootEventList_To_core_ShootEventList(in *ShootEventList, out *core.ShootEventList, s conversion.Scope) error {
	return autoConvert_v1alpha1_ShootEventList_To_core_ShootEventList(in, out, s)
}

func autoConvert_core_ShootEventList_To_v1alpha1_ShootEventList(in *core.ShootEventList, out *ShootEventList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	out.Items = *(*[]ShootEvent)(unsafe.Pointer(&in.Items))
	return nil
}

// Convert_core_ShootEventList_To_v1alpha1_ShootEventList is an autogenerated conversion function.
func Convert_core_ShootEventList_To_v1alpha1_ShootEventList(in *core.ShootEventList, out *ShootEventList, s conversion.Scope) error {
	return autoConvert_core_ShootEventList_To_v1alpha1_ShootEventList(in, out, s)
}
