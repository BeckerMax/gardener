...
func (c *FakeShootStates) Get(name string, options v1.GetOptions) (result *v1beta1.ShootState, err error) {
	obj, err := c.Fake.
...
func (c *FakeShootStates) List(opts v1.ListOptions) (result *v1beta1.ShootStateList, err error) {
	obj, err := c.Fake.
...
func (c *FakeShootStates) Create(shootState *v1beta1.ShootState) (result *v1beta1.ShootState, err error) {
	obj, err := c.Fake.
...
func (c *FakeShootStates) Update(shootState *v1beta1.ShootState) (result *v1beta1.ShootState, err error) {
	obj, err := c.Fake.
...
func (c *FakeShootStates) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(shootstatesResource, c.ns, name), &v1beta1.ShootState{})
...
func (c *FakeShootStates) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.ShootState, err error) {
	obj, err := c.Fake.
