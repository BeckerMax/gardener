...
type ShootStateInterface interface {
	Create(*v1beta1.ShootState) (*v1beta1.ShootState, error)
	Update(*v1beta1.ShootState) (*v1beta1.ShootState, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1beta1.ShootState, error)
	List(opts v1.ListOptions) (*v1beta1.ShootStateList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.ShootState, err error)
	ShootStateExpansion
}
...
func (c *shootStates) Get(name string, options v1.GetOptions) (result *v1beta1.ShootState, err error) {
...
func (c *shootStates) List(opts v1.ListOptions) (result *v1beta1.ShootStateList, err error) {
...
func (c *shootStates) Create(shootState *v1beta1.ShootState) (result *v1beta1.ShootState, err error) {
	result = &v1beta1.ShootState{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("shootstates").
...
func (c *shootStates) Update(shootState *v1beta1.ShootState) (result *v1beta1.ShootState, err error) {
	result = &v1beta1.ShootState{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("shootstates").
...
func (c *shootStates) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.ShootState, err error) {
	result = &v1beta1.ShootState{}
