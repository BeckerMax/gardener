// TODO Could it be that tableconverter is an old way of converting output and the new way in K8s
...
// TODO check how its done in k8s event
// TODO Do we even need this function?Who is calling it?
// TODO Why do we only use Context here?
...
func (c *convertor) ConvertToTable(ctx context.Context, o runtime.Object, tableOptions runtime.Object) (*metav1beta1.Table, error) {
	...
	table.Rows, err = metatable.MetaToTableRow(o, func(o runtime.Object, m metav1.Object, name, age string) ([]interface{}, error) {
		var (
			obj   = o.(*core.ShootEvent)
			cells = []interface{}{}
		)

		cells = append(cells, obj.Name)
		cells = append(cells, obj.Reason)
		// TODO is this right ?
