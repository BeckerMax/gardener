...
func (c *defaultControl) ReconcileSeed(obj *gardencorev1beta1.Seed, key string) error {
	...
	if err := seedpkg.RunReconcileSeedFlow(ctx, gardenClient, seedClient, seedObj, c.secrets, c.imageVector, c.componentImageVectors, c.config.DeepCopy(), seedLogger); err != nil {
